...
<!-- jQuery 2.2.3 -->
<script src="asset/asset_lte/plugins/jQuery/jquery-2.2.3.min.js"></script>
<!-- jQuery UI 1.11.4 -->
...
<!-- Bootstrap 3.3.6 -->
<script src="asset/asset_lte/bootstrap/js/bootstrap.min.js"></script>
<!-- Morris.js charts -->
<script src="https://cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"></script>
<script src="asset/asset_lte/plugins/morris/morris.min.js"></script>
<!-- Sparkline -->
<script src="asset/asset_lte/plugins/sparkline/jquery.sparkline.min.js"></script>
<!-- jvectormap -->
<script src="asset/asset_lte/plugins/jvectormap/jquery-jvectormap-1.2.2.min.js"></script>
