      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-plus"> Add User</i></a></li>
            <li><a href="#"><i class="fa fa-cog"> Manage User</i></a></li>
          </ul>
        </li>
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-plus"> Add Subject</i></a></li>
            <li><a href="#"><i class="fa fa-cog"> Manage Subject</i></a></li>
          </ul>
        </li>
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-plus"> Add Class</i></a></li>
            <li><a href="#"><i class="fa fa-cog"> Manage Class</i></a></li>
          </ul>
        </li>
        <li class="treeview">
